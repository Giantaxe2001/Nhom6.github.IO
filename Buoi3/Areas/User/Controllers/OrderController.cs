...
namespace Buoi3.Areas.User.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public class ChangeStatusViewModel
        {
            ...
            {
                new SelectListItem { Value = "Canceling", Text = "Canceling" }
            };
        }
        ...
        private readonly List<string> _statusList = new List<string> { "Canceling" };
        public async Task<IActionResult> ChangeStatus(int id)
        {
            ...
            var viewModel = new ChangeStatusViewModel
            {
                ...
                StatusList = _statusList.Select(s => new SelectListItem { Value = s, Text = s }).ToList()
            };
        ...
        public async Task<IActionResult> ChangeStatus(ChangeStatusViewModel model)
        {
            ...
            {
                model.StatusList = _statusList.Select(s => new SelectListItem { Value = s, Text = s }).ToList();
                return View(model);
            }
